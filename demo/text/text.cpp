...
sf::Text generation_text,  top_performer_text, first_parent_text, second_parent_text, top_performer_alltime_text, average_text;
...
void loadText(){
    ...
    first_parent_text.setPosition(0,20);
    ...
    second_parent_text.setPosition(0,40);
    ...
    top_performer_text.setPosition(0,60);

    top_performer_alltime_text.setFont(gotham_font);
    top_performer_alltime_text.setCharacterSize(18);
    top_performer_alltime_text.setFillColor(sf::Color::Black);
    top_performer_alltime_text.setPosition(0,80);
}
